...
Elm.Salem = Elm.Salem || {};
Elm.Salem.make = function (_elm) {
   "use strict";
   _elm.Salem = _elm.Salem || {};
   if (_elm.Salem.values)
   return _elm.Salem.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   ...
   $Salem$Boat = Elm.Salem.Boat.make(_elm),
   $Salem$Component = Elm.Salem.Component.make(_elm),
   $Salem$Wind = Elm.Salem.Wind.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var view = function (m) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.id("salem")]),
      _L.fromArray([$Salem$Wind.view(m.wind)
                   ,$Salem$Boat.view(m.boat)]));
   };
      ...
      return function () {
         ...
         {case "BoatAction":
            return _U.replace([["boat"
                               ,A2($Salem$Boat.update,
                               a._0,
                               m.boat)]],
              m);
            case "WindAction":
            return _U.replace([["wind"
                               ,A2($Salem$Wind.update,
                               a._0,
                               m.wind)]],
              m);}
         _U.badCase($moduleName,
   ...
   var WindAction = function (a) {
      return {ctor: "WindAction"
             ,_0: a};
   };
   var BoatAction = function (a) {
      return {ctor: "BoatAction"
             ,_0: a};
   };
   ...
   $Salem$Wind.actions));
   var init = {_: {}
              ,boat: $Salem$Boat.init
              ,wind: $Salem$Wind.init};
   var model = A3($Signal.foldp,
   update,
   init,
   actions);
   ...
   _elm.Salem.values = {_op: _op
                       ,Model: Model
                       ,init: init
                       ,BoatAction: BoatAction
                       ,WindAction: WindAction
                       ,update: update
                       ,view: view
                       ,actions: actions
                       ,model: model
...
Elm.Salem = Elm.Salem || {};
Elm.Salem.Boat = Elm.Salem.Boat || {};
Elm.Salem.Boat.make = function (_elm) {
   "use strict";
   _elm.Salem = _elm.Salem || {};
   _elm.Salem.Boat = _elm.Salem.Boat || {};
   if (_elm.Salem.Boat.values)
   return _elm.Salem.Boat.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Salem.Boat",
   $Basics = Elm.Basics.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   $Salem$Boat$Sheet = Elm.Salem.Boat.Sheet.make(_elm),
   $Salem$Boat$Tiller = Elm.Salem.Boat.Tiller.make(_elm),
   $Salem$Component = Elm.Salem.Component.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var boatStyle = function (m) {
      return _L.fromArray([{ctor: "_Tuple2"
                           ,_0: "height"
                           ,_1: "120px"}
                          ,{ctor: "_Tuple2"
                          ...
                          ,{ctor: "_Tuple2"
                           ...
                           "rotate(",
                           A2($Basics._op["++"],
                           $Basics.toString(10 * m.tiller),
                           "deg)"))}]);
   };
   var viewBoat = function (m) {
      return A2($Html.div,
      _L.fromArray([$Html$Attributes.style(boatStyle(m))]),
      _L.fromArray([$Html.text("⛵️")]));
   };
   var view = function (m) {
      return A2($Html.dl,
      _L.fromArray([]),
      _L.fromArray([A2($Html.dt,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text("Tiller: (←, →)")]))
                   ,A2($Html.dd,
                   _L.fromArray([]),
                   _L.fromArray([$Salem$Boat$Tiller.view(m.tiller)]))
                   ,A2($Html.dt,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text("Sheet: (a, d)")]))
                   ,A2($Html.dd,
                   _L.fromArray([]),
                   _L.fromArray([$Salem$Boat$Sheet.view(m.sheet)]))
                   ,A2($Html.dt,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text("The Boat:")]))
                   ,A2($Html.dd,
                   _L.fromArray([]),
                   _L.fromArray([viewBoat(m)]))]));
   };
   ...
   m) {
      return function () {
         switch (action.ctor)
         {case "SheetAction":
            return _U.replace([["sheet"
                               ,A2($Salem$Boat$Sheet.update,
                               action._0,
                               m.sheet)]],
              m);
            case "TillerAction":
            return _U.replace([["tiller"
                               ,A2($Salem$Boat$Tiller.update,
                               action._0,
                               m.tiller)]],
              m);}
         _U.badCase($moduleName,
   ...
   var SheetAction = function (a) {
      return {ctor: "SheetAction"
             ,_0: a};
   };
   var TillerAction = function (a) {
      return {ctor: "TillerAction"
             ,_0: a};
   };
   var actions = A2($Signal.merge,
   A2($Signal._op["<~"],
   TillerAction,
   $Salem$Boat$Tiller.actions),
   A2($Signal._op["<~"],
   SheetAction,
   $Salem$Boat$Sheet.actions));
   var init = {_: {}
              ,sheet: $Salem$Boat$Sheet.init
              ,tiller: $Salem$Boat$Tiller.init};
   var model = A3($Signal.foldp,
   update,
   init,
   actions);
   ...
   _elm.Salem.Boat.values = {_op: _op
                            ,Model: Model
                            ,init: init
                            ,TillerAction: TillerAction
...
Elm.Salem = Elm.Salem || {};
Elm.Salem.Boat = Elm.Salem.Boat || {};
Elm.Salem.Boat.Control = Elm.Salem.Boat.Control || {};
Elm.Salem.Boat.Control.make = function (_elm) {
   "use strict";
   _elm.Salem = _elm.Salem || {};
   _elm.Salem.Boat = _elm.Salem.Boat || {};
   _elm.Salem.Boat.Control = _elm.Salem.Boat.Control || {};
   if (_elm.Salem.Boat.Control.values)
   return _elm.Salem.Boat.Control.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Salem.Boat.Control",
   $Basics = Elm.Basics.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Salem$Component = Elm.Salem.Component.make(_elm),
   $Signal = Elm.Signal.make(_elm),
   ...
   var view = function (m) {
      return $Html.text($Basics.toString(m));
   };
   var bound = 20;
   var bind = A2($Basics.clamp,
   0 - bound,
   bound);
   var update = F2(function (action,
   m) {
   ...
   var mkActions = function (xSignal) {
      return A2($Signal.map,
      keyToAction,
      A2($Signal._op["<~"],
      function (_) {
   ...
   var mkComponent = function (xSignal) {
      return function () {
         var actions = mkActions(xSignal);
         var model = mkModel(actions);
         return {_: {}
                ,actions: actions
                ,init: 0
                ,main: A2($Signal._op["<~"],
   ...
   var XField = F2(function (a,b) {
      return _U.insert("x",a,b);
   });
   _elm.Salem.Boat.Control.values = {_op: _op
                                    ,XField: XField
                                    ,NoOp: NoOp
                                    ,Left: Left
                                    ,Right: Right
...
Elm.Salem = Elm.Salem || {};
Elm.Salem.Boat = Elm.Salem.Boat || {};
Elm.Salem.Boat.Sheet = Elm.Salem.Boat.Sheet || {};
Elm.Salem.Boat.Sheet.make = function (_elm) {
   "use strict";
   _elm.Salem = _elm.Salem || {};
   _elm.Salem.Boat = _elm.Salem.Boat || {};
   _elm.Salem.Boat.Sheet = _elm.Salem.Boat.Sheet || {};
   if (_elm.Salem.Boat.Sheet.values)
   return _elm.Salem.Boat.Sheet.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Salem.Boat.Sheet",
   $Html = Elm.Html.make(_elm),
   $Keyboard = Elm.Keyboard.make(_elm),
   $Salem$Boat$Control = Elm.Salem.Boat.Control.make(_elm),
   $Salem$Component = Elm.Salem.Component.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var component = $Salem$Boat$Control.mkComponent($Keyboard.wasd);
   ...
   _elm.Salem.Boat.Sheet.values = {_op: _op
                                  ,component: component
                                  ,init: init
                                  ,update: update
                                  ,view: view
...
Elm.Salem = Elm.Salem || {};
Elm.Salem.Boat = Elm.Salem.Boat || {};
Elm.Salem.Boat.Tiller = Elm.Salem.Boat.Tiller || {};
Elm.Salem.Boat.Tiller.make = function (_elm) {
   "use strict";
   _elm.Salem = _elm.Salem || {};
   _elm.Salem.Boat = _elm.Salem.Boat || {};
   _elm.Salem.Boat.Tiller = _elm.Salem.Boat.Tiller || {};
   if (_elm.Salem.Boat.Tiller.values)
   return _elm.Salem.Boat.Tiller.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Salem.Boat.Tiller",
   $Html = Elm.Html.make(_elm),
   $Keyboard = Elm.Keyboard.make(_elm),
   $Salem$Boat$Control = Elm.Salem.Boat.Control.make(_elm),
   $Salem$Component = Elm.Salem.Component.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var component = $Salem$Boat$Control.mkComponent($Keyboard.arrows);
   var init = component.init;
   var update = component.update;
   var view = component.view;
   var actions = component.actions;
   var model = component.model;
   var main = component.main;
   _elm.Salem.Boat.Tiller.values = {_op: _op
                                   ,component: component
                                   ,init: init
                                   ,update: update
                                   ,view: view
...
Elm.Salem = Elm.Salem || {};
Elm.Salem.Component = Elm.Salem.Component || {};
Elm.Salem.Component.make = function (_elm) {
   "use strict";
   _elm.Salem = _elm.Salem || {};
   _elm.Salem.Component = _elm.Salem.Component || {};
   if (_elm.Salem.Component.values)
   return _elm.Salem.Component.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Salem.Component",
   $Html = Elm.Html.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var Signature = F6(function (a,
   b,
   c,
   d,
   e,
   ...
   _elm.Salem.Component.values = {_op: _op
                                 ,Signature: Signature};
   return _elm.Salem.Component.values;
};
Elm.Salem = Elm.Salem || {};
Elm.Salem.Wind = Elm.Salem.Wind || {};
Elm.Salem.Wind.make = function (_elm) {
   "use strict";
   _elm.Salem = _elm.Salem || {};
   _elm.Salem.Wind = _elm.Salem.Wind || {};
   if (_elm.Salem.Wind.values)
   return _elm.Salem.Wind.values;
   var _op = {},
   _N = Elm.Native,
   _U = _N.Utils.make(_elm),
   _L = _N.List.make(_elm),
   $moduleName = "Salem.Wind",
   $Basics = Elm.Basics.make(_elm),
   $Html = Elm.Html.make(_elm),
   $Html$Attributes = Elm.Html.Attributes.make(_elm),
   ...
   var speedColor = function (speed) {
      return function () {
         var lum = $Basics.max(0)($Basics.round(100 - speed * 10));
   ...
   var transformAngle = function (direction) {
      return A2($Basics._op["++"],
      "rotate(",
      A2($Basics._op["++"],
   ...
   var arrowStyle = function (m) {
      return _L.fromArray([{ctor: "_Tuple2"
                          ...
                          ,{ctor: "_Tuple2"
                           ,_0: "transform"
                           ,_1: transformAngle(m.windDirection)}]);
   };
   var view = function (m) {
      return A2($Html.p,
      _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                         ,_0: "color"
                                                         ,_1: speedColor(m.windSpeed)}]))]),
      _L.fromArray([$Html.text(A2($Basics._op["++"],
                   $Basics.toString($Basics.round(m.windSpeed)),
                   " knots"))
                   ,A2($Html.p,
                   _L.fromArray([$Html$Attributes.style(arrowStyle(m))]),
                   _L.fromArray([$Html.text("↑")]))]));
   };
   var updateWindDirection = function (m) {
      return function () {
         ...
         prob = $._0,
         seed$ = $._1;
         var windDirection$ = A2($Basics._op["%"],
         m.windDirection + prob,
         360);
   ...
   var updateWindSpeedBy = F2(function (x,
   d) {
      return (9 * x + d) / 10;
   });
   var updateWindSpeed = function (m) {
      return function () {
         var $ = A2($Random.generate,
         ...
         prob = $._0,
         seed$ = $._1;
         var windSpeed$ = $Basics.max(0)(A2(updateWindSpeedBy,
         m.windSpeed,
         prob));
         return _U.replace([["seed"
                            ,seed$]
   ...
   var update = function (_v0) {
      return function () {
         return function ($) {
            return updateWindSpeed(updateWindDirection($));
         };
      }();
   };
   var UpdateWind = {ctor: "UpdateWind"};
   var actions = $Signal.sampleOn($Time.fps(10))($Signal.constant(UpdateWind));
   var init = function () {
      var m = {_: {}
              ,seed: $Random.initialSeed(112358)
              ,windDirection: 0
              ,windSpeed: 0};
      var $ = A2($Random.generate,
      A2($Random.$int,0,360),
   ...
   _elm.Salem.Wind.values = {_op: _op
                            ,Model: Model
                            ,init: init
                            ,UpdateWind: UpdateWind
                            ,updateWindSpeed: updateWindSpeed
                            ,updateWindSpeedBy: updateWindSpeedBy
