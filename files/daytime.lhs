...
Back in May, [Andrew Clarkson](https://github.com/andrewclarkson) gave
...
A non-server of this would just be a simple version of [`date`](https://en.wikipedia.org/wiki/Date_%28Unix%29)
